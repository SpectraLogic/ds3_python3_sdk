...
ENV["GIT_REPO"] = ENV["GIT_REPO"] || "https://github.com/SpectraLogic/ds3_python3_sdk.git"
...
puts "docker build -t #{ENV['DOCKER_REPO']} ./ds3_python3_sdk/docker/"
docker_build_output = `docker build -t #{ENV["DOCKER_REPO"]} ./ds3_python3_sdk/docker/`
docker_build_status = $?
